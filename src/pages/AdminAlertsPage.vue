        ...
        <div class="admin-content">
          <q-card class="lime-glow">
            <q-card-section>
              ...
              <div class="text-caption text-grey-6 q-mb-lg">Monitor system alerts and notifications</div>
              <div class="text-center q-pa-xl">
                <q-icon name="notifications" size="64px" color="lime" class="q-mb-md" />
                <div class="text-h6">Alerts Page</div>
                <div class="text-caption text-grey-6">This page is under development</div>
              </div>
            </q-card-section>
          </q-card>
        </div>
